      ...
      <section>
        <Container>
          <Row>
            ...
            <Col lg="6" md="6">
              <div className="single__product-cotent">
              ...
              {tab === "desc" ? (
                ...
                <div className="tab__form mb-3">
                  <div className="review pt-5">
                    ...
                    <p className="feedback__text">I love this product &#128150;</p>
                  </div>

                  <div className="review">
                    <p className="user__name mb-0">Greta Thunberg</p>
                    <p className="user__email">howdareyou@gmail.com</p>
                    <p className="feedback__text">Nothing more to say &#128076; &#128405;</p>
                  </div>

                  <div className="review">
                    <p className="user__name mb-0">Satoshi Nakamoto</p>
                    <p className="user__email">DadOfBtc@gmail.com</p>
                    <p className="feedback__text">Hmm, this tastes better than my last Ex &#128523;</p>
                  </div>
